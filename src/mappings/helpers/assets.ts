...
const assets: Assets = {
  ...
  pricingAssets: [
    ...
    Address.fromString('0xae37D54Ae477268B9997d4161B96b8200755935c'),
    Address.fromString('0x82698aeCc9E28e9Bb27608Bd52cF57f704BD1B83'),
    Address.fromString('0x2F4eb100552ef93840d5aDC30560E5513DFfFACb'),
  ],
};
