...
import { StakingMerkleTree, StakingRewardDistributionSnapshot, UserStakingRewardDistributionMetaData, TokenClaimed, UserClaimedStakingRewardDistribution, TokenDeposited } from '../types/schema';
...
export function handleClaimed(event: ClaimedEvent): void {
  ...
  if (userClaimedData == null) {
    ...
    log.warning("Already claimed {}, add new snapshot {}, old snapshots {}", [address.toHexString(), userClaimedData.snapshots.toString(), snapshotId.toString()]);
