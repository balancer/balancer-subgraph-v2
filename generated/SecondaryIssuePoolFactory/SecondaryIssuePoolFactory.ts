...
export class SecondaryIssuePoolFactory extends ethereum.SmartContract {
  ...
  create(
    ...
    _security: Address,
    _currency: Address,
    _maxAmountsIn: BigInt,
    _tradeFeePercentage: BigInt
  ): Address {
    let result = super.call(
      ...
      [
        ...
        ethereum.Value.fromUnsignedBigInt(_maxAmountsIn),
        ethereum.Value.fromUnsignedBigInt(_tradeFeePercentage)
      ]
    );
...
export class CreateCall__Inputs {
  ...
  get _maxAmountsIn(): BigInt {
    return this._call.inputValues[4].value.toBigInt();
  }

  get _tradeFeePercentage(): BigInt {
