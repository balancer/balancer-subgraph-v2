...
export class SecondaryIssuePool__getTradeResult {
  value0: BigInt;
  value1: BigInt;
...
export class SecondaryIssuePool extends ethereum.SmartContract {
  ...
  try_getOrderRef(): ethereum.CallResult<Array<Bytes>> {
    let result = super.tryCall("getOrderRef", "getOrderRef():(bytes32[])", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  getTrade(ref: Bytes): SecondaryIssuePool__getTradeResult {
    let result = super.call("getTrade", "getTrade(bytes32):(uint256,uint256)", [
      ethereum.Value.fromFixedBytes(ref)
    ]);

    return new SecondaryIssuePool__getTradeResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getTrade(
    ref: Bytes
  ): ethereum.CallResult<SecondaryIssuePool__getTradeResult> {
    let result = super.tryCall(
      "getTrade",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SecondaryIssuePool__getTradeResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
...
export class OrderFilledCall extends ethereum.Call {
  get inputs(): OrderFilledCall__Inputs {
    return new OrderFilledCall__Inputs(this);
  }

  get outputs(): OrderFilledCall__Outputs {
    return new OrderFilledCall__Outputs(this);
  }
}

export class OrderFilledCall__Inputs {
  _call: OrderFilledCall;

  constructor(call: OrderFilledCall) {
    this._call = call;
  }
...
export class OrderFilledCall__Outputs {
  _call: OrderFilledCall;
...
export class RevertTradeCall extends ethereum.Call {
  get inputs(): RevertTradeCall__Inputs {
    return new RevertTradeCall__Inputs(this);
  }

  get outputs(): RevertTradeCall__Outputs {
    return new RevertTradeCall__Outputs(this);
  }
}

export class RevertTradeCall__Inputs {
  _call: RevertTradeCall;

  constructor(call: RevertTradeCall) {
    this._call = call;
  }
...
export class RevertTradeCall__Outputs {
  _call: RevertTradeCall;
