...
export class InvestmentPool extends ethereum.SmartContract {
  ...
  try_getCollectedManagementFees(): ethereum.CallResult<
    InvestmentPool__getCollectedManagementFeesResult
  > {
    let result = super.tryCall(
      "getCollectedManagementFees",
      "getCollectedManagementFees():(address[],uint256[])",
  ...
  try_getGradualWeightUpdateParams(): ethereum.CallResult<
    InvestmentPool__getGradualWeightUpdateParamsResult
  > {
    let result = super.tryCall(
      "getGradualWeightUpdateParams",
      "getGradualWeightUpdateParams():(uint256,uint256,uint256[])",
  ...
  try_getPausedState(): ethereum.CallResult<
    InvestmentPool__getPausedStateResult
  > {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
