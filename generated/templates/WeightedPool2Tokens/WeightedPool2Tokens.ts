...
export class WeightedPool2Tokens extends ethereum.SmartContract {
  ...
  try_getMiscData(): ethereum.CallResult<
    WeightedPool2Tokens__getMiscDataResult
  > {
    let result = super.tryCall(
      "getMiscData",
      "getMiscData():(int256,int256,uint256,uint256,bool,uint256)",
  ...
  try_getPausedState(): ethereum.CallResult<
    WeightedPool2Tokens__getPausedStateResult
  > {
    let result = super.tryCall(
      "getPausedState",
      "getPausedState():(bool,uint256,uint256)",
  ...
  getTimeWeightedAverage(
    queries: Array<
      WeightedPool2Tokens__getTimeWeightedAverageInputQueriesStruct
    >
  ): Array<BigInt> {
    let result = super.call(
      "getTimeWeightedAverage",
